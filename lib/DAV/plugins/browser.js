...
//        "icons/calendar": jsCalDAV_iCalendar,
    ...
    generateDirectoryIndex: function(path, cbindex) {
        ...
        var html = "<html>\n\
<head>\n\
  <title>当前目录 " + this.escapeHTML(path) + "/ - jsDAV " + jsDAV_Server.VERSION + "</title>\n\
...
<body>\n\
  ...
  <table>\n\
    <tr><th width=\"24\"></th><th>文件名</th><th>类型</th><th>大小</th><th>修改时间</th></tr>\n\
...
<td>" + lastmodified + "</td>\n\
    ...
    htmlActionsPanel: function(e, node, output) {
        ...
        output.html = '<tr><td colspan="2"><form method="post" action="">' +
            ...
            '文件: <input type="file" name="file" value="选择文件" /><br />' +
